...
public class WeatherContract {
  ...
  public static final String CONTENT_AUTHORITY = "com.daniel.sunshine";
  ...
  // For instance, content://com.daniel.sunshine/weather/ is a valid path for looking at weather data.
  // content://com.daniel.sunshine/givemeroot/ will fail as the ContentProvider hasn't been given any information on what to do with "givemeroot".
  ...
  public static final class WeatherEntry implements BaseColumns {
    ...
    // OpenWeatherMap id as returned by API, to identify the icon to be used
